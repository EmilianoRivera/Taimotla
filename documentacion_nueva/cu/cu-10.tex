...
\begin{UseCase}{CU-10}{Registrar hecho victimal}{
	Permite al Abogado o Coordinador del equipo multidisciplinario capturar y registrar la información jurídica y descriptiva correspondiente al hecho delictivo que dio origen a la intervención de la Fundación (situación de orfandad por feminicidio del menor), asociando dichos datos directamente al expediente único de la NNA.
}
...
\begin{UCtrayectoria}
	...
	\UCpaso Muestra el mensaje de éxito {\bf MSG-09} y refresca la pestaña mostrando la información guardada.
...
\begin{UCtrayectoriaA}{B}{Campos obligatorios vacíos}
	\UCpaso Muestra el mensaje de error {\bf MSG-04} detallando que el número de reporte, nombre del caso, fecha de detención y el nombre de la madre víctima son requeridos.
...
\begin{UCtrayectoriaA}{C}{Fecha de detención inválida}
	\UCpaso Muestra el mensaje de error {\bf MSG-04} indicando que la fecha de detención ingresada no puede ser una fecha futura.
	\UCpaso[\UCactor] Presiona el botón \IUbutton{Aceptar}.
