...
\begin{UCtrayectoria}
	...
	\UCpaso Despliega el mensaje de éxito \hyperlink{mMSG09}{\bf MSG-09} confirmando la operación realizada.
...
\begin{UCtrayectoriaA}{B}{Duplicidad de datos de identidad en el sistema}
	\UCpaso Muestra el mensaje de error \hyperlink{mMSG02}{\bf MSG-02} alertando que la CURP o el correo electrónico ya existen en otro registro de cuenta activa.
	\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}.
	\UCpaso Regresa al paso 5 de la trayectoria principal.
\end{UCtrayectoriaA}
