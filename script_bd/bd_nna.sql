-- Script corregido: sin tablas duplicadas y con tipos compatibles en FK
BEGIN;
...
(
    ...
    codigo_postal character varying(50) NOT NULL,
...
-- CORRECCIÓN: id_correo como serial (integer) para ser compatible con la FK de persona
CREATE TABLE IF NOT EXISTS public.correos
(
    id_correo serial NOT NULL,
    correo character varying(100) NOT NULL,
    CONSTRAINT correo_pkey PRIMARY KEY (id_correo),
    CONSTRAINT correos_correo_key UNIQUE (correo)
);
...
(
    ...
    tipo_correo character varying(20) DEFAULT 'personal',
...
(
    ...
    tipo_telefono character varying(20) DEFAULT 'celular',
...
(
    ...
    numero_telefono character varying(20) NOT NULL,
    tipo_telefono character varying(20) DEFAULT 'principal',
...
(
    ...
    nombre_red character varying(50) NOT NULL,
...
(
    ...
    url_red_social character varying(255) NOT NULL,
    CONSTRAINT id_red_social_servicio_pkey PRIMARY KEY (id_red_social_servicio)
);

-- CORRECCIÓN: id_correo cambia a integer para ser compatible con FK a correos(id_correo)
...
(
    ...
    id_correo integer,   -- ← era character varying(100), ahora integer
...
(
    "CURP" character varying(18) NOT NULL,
    id_director_cargo character varying(18),
...
(
    ...
    curp_coordinador character varying(18) NOT NULL,
...
(
    ...
    curp_profesional character varying(18) NOT NULL,
...
(
    ...
    num_expediente character varying(20) NOT NULL,
...
(
    ...
    tipo_parentes character varying(50),
...
(
    ...
    patron_migracion character varying(100),
    id_telefono integer,
    id_correo integer,
...
(
    ...
    nombre_etnia character varying(50) NOT NULL,
...
(
    ...
    nombre_nacionalidad character varying(100) NOT NULL,
...
(
    ...
    nombre_nivel character varying(30) NOT NULL,
...
(
    ...
    nombre_variante character varying(50) NOT NULL,
    id_idioma integer,
...
(
    ...
    descripcion_grado character varying(100) NOT NULL,
...
(
    ...
    nombre_padecimiento character varying(100) NOT NULL,
    codigo_padecimiento character varying(20) NOT NULL,
...
(
    ...
    tipo_detector character varying(50) NOT NULL,
...
(
    ...
    tipo_actor character varying(50) NOT NULL,
...
(
    ...
    correo_email character varying(100) NOT NULL,
    tipo_email character varying(20) DEFAULT 'principal',
...
(
    ...
    referencias_ubicacion character varying(100),
    id_estado_actor integer,
    fecha_registro timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    registrado_por character varying(18),
    CONSTRAINT id_actor_pkey PRIMARY KEY (id_actor)
);

-- nna se crea antes de documentos_nna por la referencia circular;
-- la FK circular se resuelve con ALTER TABLE después
...
(
    ...
    id_nna integer,
    num_reporte character varying(100) NOT NULL,
    nombre_caso character varying(100) NOT NULL,
    fecha_detencion date NOT NULL,
    nombre_victima_madre character varying(100) NOT NULL,
    descripcion_delito character varying(100),
    narracion_sucedido character varying(100),
...
ALTER TABLE IF EXISTS public.municipios
    ...
    REFERENCES public.estados (id_estado) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.domicilio
    ...
    REFERENCES public.colonia (id_colonia) ON UPDATE CASCADE ON DELETE SET NULL;
...
-- CORRECCIÓN: persona.id_correo ahora es integer → referencia válida a correos(id_correo)
ALTER TABLE IF EXISTS public.persona
    ADD CONSTRAINT fk_id_correo_persona FOREIGN KEY (id_correo)
    REFERENCES public.correos (id_correo) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.personal
    ...
    REFERENCES public.persona ("CURP") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.personal
    ADD CONSTRAINT fk_estado_personal FOREIGN KEY (estado)
    REFERENCES public.estado_cuenta (id_estado) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.director
    ADD CONSTRAINT fk_personal_director FOREIGN KEY ("CURP")
    REFERENCES public.personal ("CURP") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.coordinador
    ...
    REFERENCES public.director ("CURP") ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.equipo
    ...
    REFERENCES public.coordinador ("CURP") ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE IF EXISTS public.equipo
    ADD CONSTRAINT fk_estado_equipo FOREIGN KEY (id_estado_equipo)
    REFERENCES public.estado_equipo (id_estado_equipo) ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.composicion_equipo
    ADD CONSTRAINT fk_equipo_asignado FOREIGN KEY (id_equipo)
    REFERENCES public.equipo (id_equipo) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.expediente
    ...
    REFERENCES public.estado_expediente (id_estado_expediente) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.familiares
    ...
    REFERENCES public.personas_expediente (id_persona_exp) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.tutores
    ...
    REFERENCES public.telefonos_tutores (id_telefono) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.tutores
    ADD CONSTRAINT fk_correo_tutores FOREIGN KEY (id_correo)
    REFERENCES public.correos_tutores (id_correo) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.tutores
    ADD CONSTRAINT fk_parenteso_tutores FOREIGN KEY (id_parentesco)
    REFERENCES public.parentesco (id_parentesco) ON UPDATE NO ACTION ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.tutores
    ADD CONSTRAINT fk_grado_negacion_tutores FOREIGN KEY (id_grado_negacion)
    REFERENCES public.grado_negacion (id_grado_negacion) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.tutores
    ADD CONSTRAINT fk_grado_afectacion_emocional_tutores FOREIGN KEY (id_grado_afectacion_emocional)
    REFERENCES public.grado_afectacion_emocional (id_grado_afectacion_emocional) ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.documentos
    ...
    REFERENCES public.tipo_documento_nna (id_tipo_documento_nna) ON UPDATE NO ACTION ON DELETE SET NULL;

-- nna FK (tabla ya creada arriba)
...
ALTER TABLE IF EXISTS public.nna
    ...
    REFERENCES public.etnia (id_etnia) ON UPDATE CASCADE ON DELETE SET NULL;
...
-- FK circular nna ↔ nna_historial_escolar y nna ↔ documentos_nna se agregan al final
ALTER TABLE IF EXISTS public.documentos_nna
    ADD CONSTRAINT fk_documentos_nna_nna FOREIGN KEY (id_nna)
    REFERENCES public.nna (id_nna) ON UPDATE NO ACTION ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.documentos_nna
    ADD CONSTRAINT fk_documentos_nna_documento FOREIGN KEY (id_documento)
    REFERENCES public.documentos (id_documento) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.documentos_nna
    ADD CONSTRAINT fk_documentos_nna_tipo FOREIGN KEY (id_tipo_documento_nna)
    REFERENCES public.tipo_documento_nna (id_tipo_documento_nna) ON UPDATE NO ACTION ON DELETE RESTRICT;
...
ALTER TABLE IF EXISTS public.nna_historial_escolar
    ...
    REFERENCES public.escuela (id_escuela) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.nna_historial_escolar
    ADD CONSTRAINT fk_hist_nivel FOREIGN KEY (id_nivel_educativo)
    REFERENCES public.nivel_educativo (id_nivel_educativo) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.nna_historial_escolar
    ADD CONSTRAINT fk_hist_grado FOREIGN KEY (id_grado_escolar)
    REFERENCES public.grado_escolar (id_grado_escolar) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.nna
    ADD CONSTRAINT fk_hist_actual_nna FOREIGN KEY (id_historial_escolar_actual)
    REFERENCES public.nna_historial_escolar (id_historial_escolar) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.nna_discapacidad
    ...
    REFERENCES public.tipo_discapacidad (id_tipo_discapacidad) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.nna_discapacidad
    ADD CONSTRAINT fk_grado_dependencia FOREIGN KEY (id_grado_dependencia)
    REFERENCES public.grado_dependencia (id_grado_dependencia) ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.nna_padecimientos
    ...
    REFERENCES public.padecimiento (id_padecimiento) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.nna_seguro_medico
    ...
    REFERENCES public.seguro_medico (id_seguro) ON UPDATE NO ACTION ON DELETE RESTRICT;

ALTER TABLE IF EXISTS public.acta_nacimiento
    ADD CONSTRAINT fk_acta_doc_nna FOREIGN KEY (id_documento_nna)
    REFERENCES public.documentos_nna (id_documento_nna) ON UPDATE NO ACTION ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.acta_nacimiento
    ADD CONSTRAINT fk_acta_estado_documento FOREIGN KEY (id_estado_documento)
    REFERENCES public.estado_documento (id_estado_documento) ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.cartilla_medica
    ...
    REFERENCES public.institucion_medica (id_institucion_medica) ON UPDATE NO ACTION ON DELETE SET NULL;

ALTER TABLE IF EXISTS public.hecho_victimal
    ADD CONSTRAINT fk_nna_hecho_victimal FOREIGN KEY (id_nna)
    REFERENCES public.nna (id_nna) ON UPDATE NO ACTION ON DELETE RESTRICT;

ALTER TABLE IF EXISTS public.hecho_victimal
    ADD CONSTRAINT fk_tipo_detector_hecho_victimal FOREIGN KEY (id_tipo_detector)
    REFERENCES public.tipo_detector (id_tipo_detector) ON UPDATE CASCADE ON DELETE CASCADE;
