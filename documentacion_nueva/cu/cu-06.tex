...
\begin{UCtrayectoriaA}{A}{Error al reasignar coordinador}
	...
	\UCpaso Muestra el mensaje de error {\bf MSG-04} indicando el fallo de actualización.
...
\begin{UCtrayectoriaA}{B}{Confirmación y eliminación de miembro}
	...
	\UCpaso Muestra el mensaje de éxito {\bf MSG-09} y continúa en el paso 5 de la trayectoria principal.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{D}{Confirmación de eliminación de equipo}
	...
	\UCpaso Muestra el mensaje de éxito {\bf MSG-09} y regresa al paso 2 de la trayectoria principal.
\end{UCtrayectoriaA}
