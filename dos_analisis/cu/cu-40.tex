...
\begin{UCtrayectoriaA}{A}{Nombre del valor vacío}
	\UCpaso Muestra el mensaje de error \hyperlink{mMSG04}{\bf MSG-04} indicando que el nombre del valor es obligatorio.
...
\begin{UCtrayectoriaA}{B}{Valor en uso por expedientes activos}
	\UCpaso Muestra el mensaje de advertencia \hyperlink{mMSG03}{\bf MSG-03} indicando que el valor está siendo utilizado y no puede desactivarse hasta liberar las referencias.
	\UCpaso[\UCactor] Oprime \IUbutton{Aceptar}.
