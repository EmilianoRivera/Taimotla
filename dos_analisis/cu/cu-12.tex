...
\begin{UCtrayectoria}
	...
	\UCpaso Muestra el mensaje de éxito \hyperlink{mMSG09}{\bf MSG-09} y refresca la tabla de familiares en la interfaz.
...
\begin{UCtrayectoriaA}{B}{Campos obligatorios incompletos}
	\UCpaso Muestra el mensaje de error \hyperlink{mMSG04}{\bf MSG-04} indicando los campos vacíos en el formulario del familiar.
