...
def insertar_catalogos():
    ...
    try:
        ...
        #Catalogo de Estado de la Cuenta
        query_edo_cuenta = """INSERT INTO public.estado_cuenta (estado) VALUES (%s)"""
        datos_edos_cuenta = [('Activo',),('Inactivo',), ]
        cur.executemany(query_edo_cuenta, datos_edos_cuenta)

        conn.commit()
        print("Exito al insertar")
